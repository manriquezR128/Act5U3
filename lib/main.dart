...
import 'package:manriquez0376/firebase_options.dart';
import 'package:firebase_core/firebase_core.dart';
import 'package:flutter/material.dart';
import 'package:manriquez0376/pages/home.dart';
...
class PaginaSesion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Negocio de abarrotes',
            style: TextStyle(color: Colors.white)),
        backgroundColor: const Color(0xff1000a6),
        elevation: 8,
      ),
      body: Padding(
